...
public class GameController {
    ...
    public void buttonPressed(ActionEvent ae) {
        Marker pressedMarker = (Marker)((Field)ae.getSource()).marker;
     ...
     * @throws SQLException 
     */
    public void saveGame(int option) throws SQLException {
     ...
     * @throws SQLException 
     */
    public void loadGame(int option) throws SQLException {
